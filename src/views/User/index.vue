                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="slider_img-box">
                        <div>
                          <img src="@/assets/user/images/slide-img.png" alt="" class="" />
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <section class="service_section layout_padding ">
    <div class="container">
      ...
      <div class=" layout_padding2">
        <div class="card-deck">
          <div class="card">
            <img class="card-img-top" src="@/assets/user/images/card-item-1.png" alt="Card image cap" />
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="@/assets/user/images/card-item-2.png" alt="Card image cap" />
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="@/assets/user/images/card-item-3.png" alt="Card image cap" />
            <div class="card-body">
  ...
  <section class="fruit_section">
    <div class="container">
      ...
      <div class="row layout_padding2">
        ...
        <div class="col-md-4 d-flex justify-content-center align-items-center">
          <div class="fruit_img-box d-flex justify-content-center align-items-center">
            <img src="@/assets/user/images/orange.png" alt="" class="" width="250px" />
          </div>
        </div>
      </div>
      <div class="row layout_padding2">
        ...
        <div class="col-md-4 d-flex justify-content-center align-items-center">
          <div class="fruit_img-box d-flex justify-content-center ">
            <img src="@/assets/user/images/grapes.png" alt="" class="" width="100px" />
          </div>
        </div>
      </div>
      <div class="row layout_padding2-top layout_padding-bottom">
        ...
        <div class="col-md-4 d-flex justify-content-center align-items-center">
          <div class="fruit_img-box d-flex justify-content-center align-items-center">
            <img src="@/assets/user/images/gauva.png" alt="" class="" width="250px" />
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="carousel-item active">
              <div class="client_container layout_padding2">
                <div class="client_img-box">
                  <img src="@/assets/user/images/client.png" alt="" />
                </div>
